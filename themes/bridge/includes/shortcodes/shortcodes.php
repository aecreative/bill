    ...
    function qode_carousel( $atts, $content = null ) {
        ...
        if ($carousel != "") {
            ...
            if ( have_posts() ) : $postCount = 1; while ( have_posts() ) : the_post();
                ...
                if($image != ""){
                    $html .= "<span class='first_image_holder ".$has_hover_image."'>".wp_get_attachment_image($first_image)
                        ."</span>";
                }
                ...
                if($hover_image != ""){
                    $html .= "<span class='second_image_holder ".$has_hover_image."'>".wp_get_attachment_image($second_image)."</span>";
                }
