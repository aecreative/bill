...
?>
<div class="bhlheader">
<a href="<?php bloginfo('url'); ?>" class="logo">Bill Howe</a>
...
<?php
	...
	/*
	 * billhowe_phonenumber() automatically looks for the get_post_meta($post->ID,'phone') anyways...
	$custom = get_post_meta($post->ID,'phone');
	$lnum = $custom[0];
			
	if ( !$lnum || empty($lnum) ) {*/
		$lnum = billhowe_phonenumber();
	//}
	//$lnum = billhowe_phonenumber();
